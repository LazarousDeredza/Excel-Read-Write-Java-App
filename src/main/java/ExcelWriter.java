...
////                 dd=Date[0];
//
//                if(Objects.equals(Date[0], "1")){
//                    mm="01";
//                    dd="09";
//                }else if(Objects.equals(Date[0], "2")){
//                    mm="05";
//                    dd="07";
//                }  else if(Objects.equals(Date[0], "3")){
//                mm="09";
//                dd="02";
//            }
//
...
//            row.createCell(0)
//                    .setCellValue(yyyy+"-"+mm+"-"+dd);

            //...............................................

            System.out.println("..................");
                        String[] Name=data.get(i).trim().split(" ");

                        String init= "";
                        for(int o=0;o<Name.length;o++){

                            init+=Name[o].charAt(0);
                        }

            System.out.println(init+"..");

            row.createCell(0)
                    .setCellValue(init.toString());


//            String Class=data.get(i).replace(" ","");
//
//
//            if (Objects.equals(Class, "U6A")){
//                Class="UPPER 6 ARTS";
//
//            }else if(Objects.equals(Class, "U6C")){
//                Class="UPPER 6 COMMERCIALS";
//            }else if(Objects.equals(Class, "3E")||Objects.equals(Class, "3East")){
//            Class="FORM 3 EAST";
//        } else if(Objects.equals(Class, "U6S")){
//            Class="UPPER 6 SCIENCES";
//        }
//
//            row.createCell(0)
//                    .setCellValue(Class);
